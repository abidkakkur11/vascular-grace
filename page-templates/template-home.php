    ...
    <section class="services-section py-large bg-gray-light">
        <div class="container">
            <div class="services-header flex-between">
                ...
                <a href="<?php echo esc_url( home_url( '/services/' ) ); ?>" class="btn-text text-blue hover-blue-dark hidden-mobile">
            ...
            <div class="text-center mt-8 show-mobile">
                <a href="<?php echo esc_url( home_url( '/services/' ) ); ?>" class="btn-text text-blue hover-blue-dark">
                    <?php esc_html_e( 'View all services', 'vascular-grace' ); ?>
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg>
                </a>
            </div>
