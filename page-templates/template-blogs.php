 ...
 * Template Name: Blogs
 *
 * Blog listing page — uses native WordPress Posts (not ACF).
 * The_Loop renders standard WP post data.
 * Blog pagination is handled by WP core.
 *
...
$hero_title    = vg_field( 'blogs_hero_title', get_the_ID(), "Medical insights &\n<span class=\"hero-title-accent\">health articles.</span>" );
$hero_subtitle = vg_field( 'blogs_hero_subtitle', get_the_ID(), 'Evidence-based articles on vascular health, treatment options, and patient guidance from Dr. S Srikanth Raju.' );

// Redirect to native WP blog archive query
