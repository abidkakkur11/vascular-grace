...
while ( have_posts() ) :
	...
	$phone            = vg_get_phone();
	$post_url         = esc_attr( urlencode( get_permalink() ) );
	$post_title_enc   = esc_attr( urlencode( get_the_title() ) );
	?>
	...
	<header class="about-hero-section single-post-hero bg-dark text-white relative overflow-hidden">
		...
		<div class="container relative z-10">
			...
			<nav class="about-breadcrumbs mb-6" aria-label="<?php esc_attr_e( 'Breadcrumb', 'vascular-grace' ); ?>">
				...
				<?php endif; ?>
				<span class="crumb-sep">›</span>
				<span class="crumb-active text-white truncate max-w-xs inline-block align-bottom"><?php echo esc_html( get_the_title() ); ?></span>
			</nav>
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class( 'single-article-main' ); ?>>
					...
					<div class="single-post-footer mt-12 pt-8 border-t border-slate-200 flex-between flex-wrap gap-4">
						...
						<div class="single-share-wrap flex-align gap-2">
							...
							<a href="<?php echo esc_url( 'https://api.whatsapp.com/send?text=' . $post_title_enc . '%20' . $post_url ); ?>" target="_blank" rel="noopener noreferrer" class="share-btn share-wa" aria-label="<?php esc_attr_e( 'Share on WhatsApp', 'vascular-grace' ); ?>">
							...
							<a href="<?php echo esc_url( 'https://www.linkedin.com/sharing/share-offsite/?url=' . $post_url ); ?>" target="_blank" rel="noopener noreferrer" class="share-btn share-in" aria-label="<?php esc_attr_e( 'Share on LinkedIn', 'vascular-grace' ); ?>">
							...
							<a href="<?php echo esc_url( 'https://www.facebook.com/sharer/sharer.php?u=' . $post_url ); ?>" target="_blank" rel="noopener noreferrer" class="share-btn share-fb" aria-label="<?php esc_attr_e( 'Share on Facebook', 'vascular-grace' ); ?>">
							...
							<a href="<?php echo esc_url( 'https://twitter.com/intent/tweet?url=' . $post_url . '&text=' . $post_title_enc ); ?>" target="_blank" rel="noopener noreferrer" class="share-btn share-x" aria-label="<?php esc_attr_e( 'Share on X', 'vascular-grace' ); ?>">
